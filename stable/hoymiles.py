...
def send_hass(hoymiles_h: Hoymiles, mqtt_h: MqttApi):
    ...
    var_comuns = {
        "plant": {
            ...
            "via_device": SHORT_NAME + "_" + str(hoymiles_h.plant_id),
            "sid": SID,
        ...
        var_comuns.update(
            {
                f"dtu_{dtu.id}": {
                    ...
                    "via_device": SHORT_NAME + "_" + str(dtu.id),
                    "sid": SID,
                    "plant_id": str(hoymiles_h.plant_id),
                    "uniq_id": dtu.uuid,
                }
        ...
        var_comuns.update(
            {
                f"micro_{micro.id}": {
                    ...
                    "via_device": SHORT_NAME + "_" + str(micro.id),
                    "sid": SID,
                    "plant_id": str(hoymiles_h.plant_id),
                    "uniq_id": micro.uuid,
                }
        ...
        var_comuns.update(
            {
                f"bms_{bms.id}": {
                    ...
                    "via_device": SHORT_NAME + "_" + str(bms.id),
                    "sid": SID,
                    "plant_id": str(hoymiles_h.plant_id),
                    "uniq_id": bms.uuid,
                }
